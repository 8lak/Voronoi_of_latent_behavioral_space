...
df_features.to_csv("data_in_csv/21_set_raw.csv", index=False)
...
np.savetxt("data_in_csv/s_total_features.csv", S_total, delimiter=",")
print("File saved successfully.")
np.savetxt("data_in_csv/feature_names.csv", df_features.columns, fmt='%s')
