...
S_TOTAL_FILE = "s_total_features.csv"
FEATURE_NAMES_FILE = "feature_names.csv" # You'll need this file from Phase 1
...
VORONOI_SITES_FILE = "voronoi_sites.csv"
MANIFOLD_POINTS_FILE = "manifold_points.csv"
